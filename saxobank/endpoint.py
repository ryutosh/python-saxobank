...
GET_CHART_CHARTS = Endpoint("chart/v1/charts", HttpMethod.GET, Dimension.ChartMinute)

# CHART_CHARTS_SUBSCRIPTIONS_DELETE = Endpoint(
#     "chart/v1/charts/subscriptions",
#     HttpMethod.DELETE,
#     Dimension.ChartMinute,
#     request_model=chart.charts.ReqSubscriptionDelete,
# )
...
#     "port/v1/clients/me",
#     HttpMethod.GET,
#     Dimension.PortfolioMinute,
#     response_model=port.clients.MeRes,
# )
...
#     HttpMethod.GET,
#     Dimension.PortfolioMinute,
#     response_model=port.positions.MeRes,
# )
# PORT_POSITIONS_POSITIONID_GET = Endpoint(
...
# ROOT_SESSIONS_CAPABILITIES_GET = Endpoint(
#     "root/v1/sessions/capabilities", HttpMethod.GET, Dimension.RootMinute
# )
