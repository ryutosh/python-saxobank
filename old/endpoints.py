...
ROOT_SESSIONS_CAPABILITIES = E("root/v1/sessions/capabilities", M.GET, "RootMinute")
ROOT_SESSIONS_CAPABILITIES_PATCH = E("root/v1/sessions/capabilities", M.PATCH, "RootMinute")
